...
//         ? all
//         : all
//             .where((lec) => lec.subject.toLowerCase().contains(search.toLowerCase()))
//             .toList();

//     setState(() {
//       _displayedLectures = filtered;
//       isLoading = false;
//       errorMessage = filtered.isEmpty ? 'لا يوجد بيانات مخزنة لهذا اليوم' : '';
//     });
//   }
...
//         backgroundColor: Colors.transparent,
//         elevation: 0,
//         title: Text('مواعيد المحاضرات',
//             style: getArabLightTextStyle(context: context, color: AppColors.mywhite, fontSize: 20)),
//         centerTitle: true,
//         leading: IconButton(
...
//           EduTrackContainer(),
//           const LinesImage(),
//           const CenterImageLecture(nameImage: AppImages.time2),
//           Positioned(
//             left: 0,
//             right: 0,
//             bottom: 550.h,
...
//             right: 0,
//             bottom: -20.h,
//             child: SizedBox(height: 600.h, child: _buildLectureList()),
//           ),
//         ],
//       ),
//     );
...
//             child: ChoiceChip(
//               label: Text(day,
//                   style: TextStyle(color: selected ? AppColors.myBlue : AppColors.mywhite)),
//               selected: selected,
//               selectedColor: Colors.white,
//               backgroundColor: AppColors.myBlue,
//               onSelected: (_) {
...
//             style: getArabBoldTextStyle(context: context, color: AppColors.mywhite)),
//       );
//     }
...
//         itemCount: _displayedLectures.length,
//         itemBuilder: (context, index) {
//           final lec = _displayedLectures[index];
//           return Card(
//             elevation: 6,
//             child: ExpansionTile(
//               textColor: AppColors.myBlue,
...
//                   style: getArabLightTextStyle12(context: context, color: AppColors.myBlue)),
//               children: [
//                 ListTile(
//                   title: Column(
//                     crossAxisAlignment: CrossAxisAlignment.start,
//                     children: [
//                       Text('المادة: ${lec.subject}', style: const TextStyle(color: AppColors.myBlue)),
//                       Text('الدكتور: ${lec.doctor}', style: const TextStyle(color: AppColors.myBlue)),
//                       Text('المكان: ${lec.location}', style: const TextStyle(color: AppColors.myBlue)),
//                     ],
//                   ),
//                   trailing: Text('الوقت: ${lec.timeFrom} - ${lec.timeTo}\n${lec.date}',
//                       style: const TextStyle(color: AppColors.myBlue)),
//                 )
//               ],
//             ),
...
// class CenterImageLecture extends StatelessWidget {
//   final String nameImage;
//   const CenterImageLecture({required this.nameImage, super.key});
